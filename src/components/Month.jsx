            ...
            <div className="session">
                ...
                <div className="judul">
                   ...
                   <div className="card-table">
                     <Link to="/day" style={{ textDecoration:"none" }}><span >Day</span></Link>
                     <Link to="/week" style={{ textDecoration:"none" }}><span >Week</span></Link>
                     <Link to="/month"><button className="btnDay">Month</button></Link>
                   </div>
                ...
                <div className="coverContent">
                  ...
                  <div className="coverDayActive">
                    <p style={{ position:"absolute", left:"2vw", bottom:"58vh" }}><b>Month 1</b></p>
                  ...
                  <div className="coverDay">
                    <p style={{ position:"absolute", left:"2vw", bottom:"45vh", color:"#ccc" }}>Month 2</p>
                    <div className="copContent">
                  ...
                  <div className="coverDay1">
                    <p style={{ position:"absolute", left:"2vw", bottom:"55vh", color:"#ccc" }}>Month 3</p>
                    <div className="copContent">
