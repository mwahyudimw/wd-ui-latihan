            ...
            <div className="session">
                ...
                <div className="judul">
                   ...
                   <div className="card-table">
                     ...
                     <Link to="/week"><button className="btnDay">Week</button></Link>
                ...
                <div className="coverContent">
                  ...
                  <div className="coverDayActive">
                    <p style={{ position:"absolute", left:"2vw", bottom:"58vh" }}><b>Week 1</b></p>
                  ...
                  <div className="coverDay">
                    <p style={{ position:"absolute", left:"2vw", bottom:"45vh", color:"#ccc" }}>Week 2</p>
                    <div className="copContent">
                  ...
                  <div className="coverDay1">
                    <p style={{ position:"absolute", left:"2vw", bottom:"55vh", color:"#ccc" }}>Week 3</p>
                    <div className="copContent">
